...
from app.RabbitMQProcessor.UserRabbitMQProcessor import check_token_processor, register_processor, \
    ...
    resend_otp_processor, change_password_processor, request_change_password_processor, \
...
from app.blueprints import ban_client, verify_user_client, check_token_client, register_client, login_client, \
    validate_account_client, resend_validate_account_client, validate_otp_client, resend_otp_client, \
...
def logout():
    ...
    resp = make_response('Session removed', 200)
    resp.set_cookie('jwt', '', expires=0, samesite='None', secure=True, httponly=False)
    return resp
