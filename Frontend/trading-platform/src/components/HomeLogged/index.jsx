...
React.useEffect(()=>{
    if(buttonHomeClicked === 'mywatchlist')
    {
        for (const i in datas) {
            if(datas[i].stock_symbol === buttonStockClicked)
            {

                setPriceClicked(datas[i].price);
            }
        }
    }
}, [datas]);
...
React.useEffect(()=>{
    if(buttonHomeClicked === 'popular')
    {
        for (const i in datasPopular) {
            if(datasPopular[i].stock_symbol === buttonStockClicked)
            {

                setPriceClicked(datasPopular[i].price);
            }
        }
    }
}, [datasPopular]);
...
React.useEffect(()=>{
    if(buttonClicked === 'pie')
    {
        for (const i in datasForInvest) {
            if(datasForInvest[i].stock_symbol === buttonStockClicked)
            {
 
                setPriceClicked(datasForInvest[i].price);
            }
        }
    }
}, [datasForInvest]);
...
React.useEffect(()=>{
    ...
    {
        for (const i in recommendationValue) {
            if(recommendationValue[i].stock_symbol === buttonStockClicked)
            {

                setPriceClicked(recommendationValue[i].price);
            }
        }
    }
}, [recommendationValue]);
