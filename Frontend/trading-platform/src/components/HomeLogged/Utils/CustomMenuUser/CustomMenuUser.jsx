...
export function CustomMenuUser({ anchorUser, handleCloseUser, deposit, manageFunds, settings, history, logout }) {
    return (
        <Menu
            keepMounted
            anchorEl={anchorUser}
            ...
            style={{
                sx: { width: anchorUser && anchorUser.offsetWidth },
            }}
        >
