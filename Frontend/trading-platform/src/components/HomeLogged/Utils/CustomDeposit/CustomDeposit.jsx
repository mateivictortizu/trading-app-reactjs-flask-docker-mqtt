    ...
    return (
        <div>
            ...
            >
                ...
                <DialogContent style={{ backgroundColor: '#E8E8E8', fontSize: '30px' }}>
                    Select deposit method
                </DialogContent>
                <Button id="buttonForgotPassword" style={{ width: "90%", margin: "10px", alignSelf: "center" }}>
                    <svg style={{ position: 'absolute', left: '20px' }} xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
                ...
                <Button id="buttonForgotPassword" style={{ width: "90%", margin: "10px", alignSelf: "center" }} >
                    <svg style={{ position: 'absolute', left: '20px' }} xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
