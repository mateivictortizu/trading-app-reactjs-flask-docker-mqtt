...
import { checkIsValidUsername, checkIsValidPassword, checkIsValidEmail, checkIsValidPhone, checkIsValidName, checkIsValidSurname, checkIsValidDate } from '../validator'
...
export default function UnauthentichatedHeader() {
    ...
    function checkFields(usernameRegister, passwordRegister, emailRegister, nameRegister, surnameRegister, addressRegister, nationality, country, phoneRegister, dateBirthRegister){
        var result=true
    ...
    const handleSendRegister = () => {
        setAllErrorsRegisterFalse();
        if (checkFields(usernameRegister, passwordRegister, emailRegister, nameRegister, surnameRegister, addressRegister, nationality, country, phoneRegister, dateBirthRegister)) {
