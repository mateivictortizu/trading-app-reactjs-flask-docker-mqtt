...
class Stock(db.Model):
    ...
    def __init__(self, stock_symbol):
        ...
        if self.stock_symbol != 'TUIASI':
            ...
            self.currency = 'USD'
            self.isin = '221294356'
            self.one_day = json.dumps([{"x": "06-07-2022 09:30", "y": 100}, {"x": "06-07-2022 10:00", "y": 142.76},
                                       ...
                                       {"x": "06-07-2022 15:00", "y": 143.88}, {"x": "06-07-2022 15:30", "y": 100}])
            self.one_month = json.dumps([{"x": "06-07-2022 09:30", "y": 100}, {"x": "06-07-2022 10:00", "y": 142.76},
                                         {"x": "06-07-2022 10:30", "y": 142.23}, {"x": "06-07-2022 11:00", "y": 141.54},
                                         {"x": "06-07-2022 11:30", "y": 141.71},
                                         {"x": "06-07-2022 12:00", "y": 141.93}, {"x": "06-07-2022 12:30", "y": 141.9},
                                         {"x": "06-07-2022 13:00", "y": 142.18}, {"x": "06-07-2022 13:30", "y": 142.44},
                                         {"x": "06-07-2022 14:00", "y": 143.05}, {"x": "06-07-2022 14:30", "y": 143.62},
                                         {"x": "06-07-2022 15:00", "y": 143.88}, {"x": "06-07-2022 15:30", "y": 100}])
            self.three_month = json.dumps([{"x": "06-07-2022 09:30", "y": 100}, {"x": "06-07-2022 10:00", "y": 142.76},
                                           {"x": "06-07-2022 10:30", "y": 142.23},
                                           {"x": "06-07-2022 11:00", "y": 141.54},
                                           {"x": "06-07-2022 11:30", "y": 141.71},
                                           {"x": "06-07-2022 12:00", "y": 141.93},
                                           {"x": "06-07-2022 12:30", "y": 141.9},
                                           {"x": "06-07-2022 13:00", "y": 142.18},
                                           {"x": "06-07-2022 13:30", "y": 142.44},
                                           {"x": "06-07-2022 14:00", "y": 143.05},
                                           {"x": "06-07-2022 14:30", "y": 143.62},
                                           {"x": "06-07-2022 15:00", "y": 143.88}, {"x": "06-07-2022 15:30", "y": 100}])
            self.six_month = json.dumps([{"x": "06-07-2022 09:30", "y": 100}, {"x": "06-07-2022 10:00", "y": 142.76},
                                         {"x": "06-07-2022 10:30", "y": 142.23}, {"x": "06-07-2022 11:00", "y": 141.54},
                                         {"x": "06-07-2022 11:30", "y": 141.71},
                                         {"x": "06-07-2022 12:00", "y": 141.93}, {"x": "06-07-2022 12:30", "y": 141.9},
                                         {"x": "06-07-2022 13:00", "y": 142.18}, {"x": "06-07-2022 13:30", "y": 142.44},
                                         {"x": "06-07-2022 14:00", "y": 143.05}, {"x": "06-07-2022 14:30", "y": 143.62},
                                         {"x": "06-07-2022 15:00", "y": 143.88}, {"x": "06-07-2022 15:30", "y": 100}])
            self.max = json.dumps([{"x": "06-07-2022 09:30", "y": 100}, {"x": "06-07-2022 10:00", "y": 142.76},
                                   {"x": "06-07-2022 10:30", "y": 142.23}, {"x": "06-07-2022 11:00", "y": 141.54},
                                   {"x": "06-07-2022 11:30", "y": 141.71},
                                   {"x": "06-07-2022 12:00", "y": 141.93}, {"x": "06-07-2022 12:30", "y": 141.9},
                                   {"x": "06-07-2022 13:00", "y": 142.18}, {"x": "06-07-2022 13:30", "y": 142.44},
...
class Price(db.Model):
    ...
    def to_json(self):
        return {'stock_symbol': self.stock_symbol, 'company_name': self.company_name, 'price': self.price,
                ...
                'recommendationMean': self.recommendationMean, 'lastModify': self.lastModify, 'updown': self.updown}
